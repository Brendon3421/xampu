...
<html>
	<head>
		<link rel="shortcut icon" href="assets/imgs/dolphin1.ico" type="image/x-icon" />
	...
	<body>
		<header>
			<a <?php if(isset($_SESSION['logged'])){ ?> href="?pagina=seg" <?php } else { ?> href="?pagina=home" <?php } ?> > <img src="assets/imgs/dolphin1.png"> </a>
